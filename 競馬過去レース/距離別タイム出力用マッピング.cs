...
namespace 競馬過去レース
{
    ...
    public class 距離別タイム出力用マッピング2 : ClassMap<距離別タイム格納クラス>
    {
        private 距離別タイム出力用マッピング2()
        {
            Map(x => x.馬名).Index(0).Name("馬名");
            ...
            Map(x => x.芝2400).Index(7).Name("芝2400");
            Map(x => x.芝2500).Index(8).Name("芝2500");
            Map(x => x.芝3000).Index(9).Name("芝3000");
            Map(x => x.ダ1200).Index(10).Name("ダ1200");
            Map(x => x.ダ1400).Index(11).Name("ダ1400");
            Map(x => x.ダ1600).Index(12).Name("ダ1600");
            Map(x => x.ダ1800).Index(13).Name("ダ1800");
        }
    }
